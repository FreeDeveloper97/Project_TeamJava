...
//            list.add("취소");
    ...
    void stopInputData() {
        ...
        String sendMsg = "TIME=" + TIME + "&DATA=" + DATA;
        //보내기
...
//            getTask.execute();
    ...
    class POSTTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try{
                String str;
//                URL url=new URL("http://172.20.10.2:8080/FineDust/POST");
                URL url=new URL("http://192.168.55.15:8080/FineDust/POST");
                ...
                sendMsg="spotName=서울시 관악구 남현동&dustDegree="+DATA+"&time="+TIME+"&isIndoor=0";     //isIndoor 0은 실내 1은 실외
    ...
    void test(String inputData) {
        //내부저장 테스트
        SharedPreferences sharedPref = getSharedPreferences("myPref",Context.MODE_PRIVATE);
        SharedPreferences.Editor prefEditor = sharedPref.edit();
        prefEditor.putString("jsonArray",inputData);
        prefEditor.commit();
    }
